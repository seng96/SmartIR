...
## Reload behavior
After you update the `fan:` SmartIR YAML configuration or modify an existing file in `codes/fan/*.json`, you can call the `smartir.reload` service to rebuild SmartIR fan entities without restarting the whole Home Assistant instance.
